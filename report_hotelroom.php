...
if($Site_Info->check_TBAction($_SESSION["sCONTROLLVL"],$_GET["tbn"],$_GET["as"]))
{
	...
	$filename="Rooming_".$_SESSION["sUSERID"]."_".date("Ymd").".xls";
	...
	$r_tblist = array_flip($tblist);
        // Remove fields
	$fs = array("blacklist","fullname","sex", "player_type", "pickuptime") ;
	...
	ob_start();
	print "<tr><td colspan=".($tbcount)."><div align=center class=ftitle5>Hotel Rooming List";
/*
...
*/
	...
	?>
	<? /* <div align=center class=ftitle5>Hotel Rooming List</div> */?>
